...
2) - name : Tunisian derja ASR model: 
...
3) - name :  Automatic Parking Garage Door with Facial Recognition:
...
4) - name :  Tunisian ID Card OCR System: Built an OCR system for Tunisian ID cards using Flutter and Python.
...
5) - name :  SynAI Writing Assistant: Developed a writing assistant extension for Google Docs using LLMs.
-details : 
